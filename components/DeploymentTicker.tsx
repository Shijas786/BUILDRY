...
export default function DeploymentTicker() {
  ...
  return (
    <div className="w-full bg-[var(--bg-primary)] border-b border-[var(--border)] h-9 flex items-center overflow-hidden relative z-50">
      ...
      <div className="animate-marquee flex items-center gap-12 whitespace-nowrap pl-[140px]">
